<template>
    <!-- Nút chuyển chế độ -->
    <button @click="showHelper = !showHelper" class="fixed top-4 right-4 z-[9999] px-5 py-3 text-lg font-bold bg-gradient-to-r from-blue-500 to-indigo-600 
    ...
    <div class="flex gap-0 transition-all duration-300">
        ...
        <div v-show="!showHelper || isLargeScreen" :class="{ 'flex-1': !showHelper, 'w-[60%]': showHelper }"
        ...
        <div v-if="showHelper" :class="{ 'w-full': !isLargeScreen, 'w-[50%]': isLargeScreen }"
            class="transition-all duration-300">
